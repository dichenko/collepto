  ...
  return (
    ...
    >
      <CardHeader className="p-0">
        <div 
          // Убираем cursor-pointer отсюда, так как вся карточка кликабельна
      ...
      <CardFooter className="p-4 pt-0">
        <Button
          ...
          // Эта кнопка теперь является частью общего клика по карточке,
          // но можно оставить для визуального акцента.
          // Клик по ней также вызовет навигацию.
        >
