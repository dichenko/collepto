...
/**
 * Creates item URL path
 */
export function createItemPath(title: string, id: string): string {
  return `/items/${createSlug(title, id)}`;
}

/**
 * Creates blog post URL path
 */
export function createBlogPostPath(title: string, id: string): string {
  return `/blog/${createSlug(title, id)}`;
}
